...
public:
	...
	void loadWorld(Game *game, wstring levelName, wstring levelInitFile);
	...
	void makeRandomFloatingBot(Game *game, AnimatedSpriteType *randomJumpingBotType, float initX, float initY);
